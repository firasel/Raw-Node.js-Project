          ...
          tokenHandler._token.verify(
            ...
            (tokenIsValid) => {
              if (tokenIsValid) {
                ...
                // store the update data {checkObject}
                  ...
                  data.read(
                    ...
                    (err, userData) => {
                      ...
                      if (!err && userData) {
                        ...
                        // remove the deleted check id from user's list of chechs
                        ...
                        if (checkPosition > -1) {
                          ...
                          callback(500, {
                            error:
                              "The chech id that you are trying to remove is not found in user!",
                          });
                        }
                      } else {
                        callback(500, {
